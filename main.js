...
const green = document.querySelector('.opt1');
const yellow = document.querySelector('.opt2');
const blue = document.querySelector('.opt3');
...
yellow.addEventListener('click', function changeColor() {
...
document.querySelector('#cards').innerHTML = 
    createCard(
        "20/11", "domingo", '<h1>Cerimônia de Abertura</h1>' +
        createGame("catar", "13:00", "equador")
    ) +
    createCard("21/11", "segunda", 
        createGame("inglaterra", "10:00", "iran") +
        createGame("senegal", "13:00", "holanda") +
        createGame("eua", "16:00", "paisDeGales")
    ) +
